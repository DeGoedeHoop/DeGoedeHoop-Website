            ...
            {[
              ...
              <div key={section.title}>
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "0.85rem" }}>
                  <span style={{ fontSize: "1.4rem" }} aria-hidden="true">{section.icon}</span>
                  <h2 style={{ fontFamily: "Playfair Display, serif", fontSize: "1.2rem", fontWeight: 700, color: "#1a2744" }}>{section.title}</h2>
                </div>
                <p style={{ color: "#444", fontSize: "0.97rem", lineHeight: 1.8, paddingLeft: "2.1rem" }}>{section.content}</p>
              </div>
            ))}
          </div>
